                    ...
                    <div id="content_right1">
                     ...
                     <table align="center">
                    	<form action="xulylogin.php" method="post">
    						...
    						<tr><td align="right">Tên đăng nhập : </td><td><input type="text"  name="user" required="required" /></td></tr>
        					<tr><td align="right">Mật khẩu : </td><td><input type="password" name="password" required="required"  /></td></tr>
                            <tr><td></td><td>Ghi nhớ mật khẩu : <input type="checkbox" name="luupass" required > </td></tr>
       						<tr><td></td><td><input type="submit" value="Đăng Nhập" /> <input type="reset" value="Nhập lại" /></td></tr>
    					</form>
                         </table>
                    </div>
