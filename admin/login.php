                   ...
                   <div id="content_left2">
                     ...
                     <table align="center">
                    	<form action="xuly.php" method="post">
    						...
    						<tr><td align="right">Tên đăng nhập : </td><td><input type="text"  name="User" placeholder="vào user: admin" required="required" /></td></tr>
        					<tr><td align="right">Mật khẩu : </td><td><input type="password" name="Password" placeholder="mật khẩu : admin" required="required"  /></td></tr>
                            <tr><td></td><td>Ghi nhớ mật khẩu : <input type="checkbox" name="luupass" > </td></tr>
