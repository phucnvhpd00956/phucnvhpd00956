	...
	<div id="wrapper">
        ...
        <div id="main_container">
        	<div id="content_left">
			 ...
			 <?php 
			 $id=$_GET['id'];
			 $products= productsHT($id);
			 ?>

				<div id='sanpham5'>
				  <h3>Tên : <?php echo $products[0]['name'];	?></h3>
				  <h3>Giá : <?php echo $products[0]['price'];	?> VNĐ</h3>
				  <form action='view.php?id=<?php echo $products[0]['productID'];	?>' method='GET'>
				  <p>Nhập số lượng muốn mua:</p> <input type='text' name='txtSL'/>
				  <input type='hidden' name='txtID' value='<?php echo $products[0]['productID'];?>'/>
				  <input type='submit' value='Mua'/></a>
				  <form>
			<br/>

				  <img src='../images/<?php echo $products[0]['images'];	?>' alt= 'anh dep' width='120' height ='100' align='left'/>
				<?php echo $products[0]['infomation'];	?>
